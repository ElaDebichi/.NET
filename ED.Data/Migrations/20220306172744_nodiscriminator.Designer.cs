...
namespace ED.Data.Migrations
{
    ...
    [Migration("20220306172744_nodiscriminator")]
    partial class nodiscriminator
    {
            ...
            modelBuilder.Entity("ED.domain.Biological", b =>
                {
                    b.HasOne("ED.domain.Product", null)
                        .WithOne()
                        .HasForeignKey("ED.domain.Biological", "ProductId")
            ...
            modelBuilder.Entity("ED.domain.Chemical", b =>
                {
                    b.HasOne("ED.domain.Product", null)
                        .WithOne()
                        .HasForeignKey("ED.domain.Chemical", "ProductId")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
                });
